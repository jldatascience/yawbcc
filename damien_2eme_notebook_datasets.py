...
def fetch_barcelona_wbc(force_download=False):
    """
    Fetch WBC dataset from Barcelona.

    :param force_download: Force to download again the dataset.
    """
...
def load_barcelona_wbc():
    """
    Load WBC dataset from Barcelona.

    :return: A dataframe with some metadata.
    """
