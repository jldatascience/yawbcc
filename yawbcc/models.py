from tensorflow.keras.layers import Input, Lambda, Flatten, Dense, Dropout, Conv2D, GlobalAveragePooling2D
...
def model_factory(base_model, top_net, input_shape=(128, 128, 3), pooling=None, transformers=None, name=None):
    # Try to locate a trained model based on its name
    model_function = getattr(tf.keras.applications, base_model)
