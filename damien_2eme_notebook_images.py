...
def central_pad_and_crop(img, size):
    """
    Returns a centering padded and cropped version of the image.

    :param image: The image to pad and crop as numpy array.
    :param: size: The output size in pixels, given as a (width, height) tuple.
...
def show_image_with_hist(img, height=4):
    """
    Returns a centering padded and cropped version of the image.
